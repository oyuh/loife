...
export function WeekStrip({
  ...
  return (
    <section>
      ...
      */}
      <div className="-mx-5 flex snap-x snap-mandatory gap-2 overflow-x-auto px-5 sm:mx-0 sm:grid sm:grid-cols-7 sm:gap-1 sm:overflow-visible sm:px-0">
        {week.map((day) => {
          ...
          return (
            <div
              className={cn(
                'w-[7.5rem] shrink-0 snap-start rounded-md border border-border p-2 sm:w-auto',
